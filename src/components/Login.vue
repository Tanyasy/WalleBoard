<template>
  <div class="login_container">
    ...
    <div :class="showLogin?'login_box':'register_box'">
      <el-link v-if="!showLogin" @click="showLogin = true" :underline="false">
        <el-icon>
          <arrow-left-bold/>
        </el-icon>
      </el-link>
      ...
      <el-form
          ...
          class="register_form"
      >
        <i class="ArrowLeftBold" @click="showLogin = true"></i>
        <!-- 用户 -->
  ...
  setup() {
    ...
    const login = () => {
      loginFormRef.value.validate(async (valid) => {
        ...
        req("post", "login/access-token", qs.stringify(loginForm), true)
            .then((response) => {
